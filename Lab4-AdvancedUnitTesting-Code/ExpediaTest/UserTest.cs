...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        public void TestThatUserDoesRemoveFlightFromServiceLocatorWhenBooked()
        {
            ...
            DateTime bookingEndDate = new DateTime(2011, 1, 2);

            var flightToBook = new Flight(startDate, bookingEndDate, 100);
            var remainingFlight = new Flight(startDate, startDate, 10);
